...
/**
 * The nonOOP.Board class models the TTT game-board of 3x3 cells.
 */
public class Board {  // save as "nonOOP.Board.java"
    // Define named constants for the grid
    public static final int ROWS = 3;
    public static final int COLS = 3;

    // Define properties (package-visible)
    /** A board composes of [ROWS]x[COLS] nonOOP.Cell instances */
    Cell[][] cells;
